...
{
    public class BanHangUpdateBusiness:ConnectDatabase
    {
        ...
        public void Execute()
        {
            using (var conn = new SqlConnection(ConnectionString))
            {
                ...
                {
                    conn.Open();
                    cmd.CommandText = "UPDATE BanHang SET TenSanPham=@TenSanPham,SoLuong=@SoLuong,Giaban=@Giaban,NgayBan=@NgayBan,NhomHanghoaId=@NhomHanghoaId WHERE ID=@ID AND HanghoaId=@HanghoaId ";
